<template>
  <v-card>
    <v-toolbar>
      ...
      <v-btn v-tooltip="'Close'" icon="mdi-close" @click="closeProduct()" />
    </v-toolbar>
    <div class="row">
      <div class="col">
        <v-skeleton-loader
    ...
    <div v-if="!skeleton" class="comments">
      ...
      <v-card class="comment" subtitle="User" title="John">
        ...
        <template #append>
          <v-avatar size="50">
            <v-img alt="John" src="https://cdn.vuetifyjs.com/images/john.png" />
          </v-avatar>
        </template>
        <v-card-text>
      ...
      <v-card class="comment comment-ringt" subtitle="You" title="Pepe">
        ...
        <template #append>
          <v-avatar size="50">
            <v-img alt="You" src="https://cdn.vuetifyjs.com/images/john.png" />
          </v-avatar>
        </template>
        <v-card-text>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
...
<style lang="scss" scoped src="../styles/product.scss"></style>
